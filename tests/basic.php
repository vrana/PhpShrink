...
check('class C { static $x; } echo C::/* c */$x;', 'class C{static$x;}echo C::$x;');
check('class C { static $x; } echo C:: $x;', 'class C{static$x;}echo C::$x;');
...
check('class C { function f() {} static $ab = 1; } echo C::$ab;', 'class C{function f(){}static$ab=1;}echo C::$ab;');
check('class C { function f() { static $x; } static $y; }', 'class C{function f(){static$a;}static$y;}');
check('$_ENV["a"] = 1;', '$_ENV["a"]=1;');
check('echo $_REQUEST["a"];', 'echo$_REQUEST["a"];');
check('if ($argc) { echo $argv[0]; }', 'if($argc)echo$argv[0];');
check('A . 1', 'A. 1');
check('A . 1.1', 'A. 1.1');
check('1 . A', '1 .A');
check('1. . A', '1..A');
